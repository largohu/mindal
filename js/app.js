(() => {
        ...
        if (
          ...
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              P = e.isHorizontal() ? L(r, "width", !0) : L(r, "height", !0);
            else {
              const e = t(n, "width"),
                s = t(n, "padding-left"),
                i = t(n, "padding-right"),
  ...
  function oe(e) {
    ...
    function u() {
      ...
      if (
        ...
        if (
          (s.dynamicBullets &&
            ((a = L(r[0], t.isHorizontal() ? "width" : "height", !0)),
            p.forEach((e) => {
  ...
  Object.keys(se).forEach((e) => {
    ...
    window.addEventListener("load", function (e) {
      de(),
        document.querySelector(".discounts__slider") &&
          new re(".discounts__slider", {
            modules: [ae, oe],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
            ...
            autoHeight: !0,
            speed: 800,
            pagination: { el: ".discounts__dotts", clickable: !0 },
            navigation: {
              nextEl: ".arrow-discounts__next",
              prevEl: ".arrow-discounts__prev",
            },
            on: {},
          }),
        document.querySelector(".equipment__slider") &&
          new re(".equipment__slider", {
            modules: [ae, oe],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
            ...
            autoHeight: !0,
            speed: 800,
            pagination: { el: ".equipment__dotts", clickable: !0 },
            navigation: {
              nextEl: ".arrow-equipment__next",
              prevEl: ".arrow-equipment__prev",
            },
            on: {},
          });
    });
  ...
  new pe("max").init();
  let ue = [44.899045074602014, 37.33748649999996];
  ymaps.ready(function () {
    let e = new ymaps.Map("map", { center: ue, zoom: 18 }),
      t = new ymaps.Placemark(
        ue,
        {},
        {
          iconLayout: "default#image",
          iconImageHref: "img/iconmoon/indekator.svg",
          iconImageSize: [44, 64],
